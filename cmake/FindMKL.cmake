...
if (EXISTS ${MKLROOT_PATH}/mkl)
    SET(MKL_FOUND TRUE)
    message(STATUS "MKL is found at ${MKLROOT_PATH}/mkl")
    IF(CMAKE_SIZEOF_VOID_P EQUAL 8)
        ...
        if ( ARMADILLO_FOUND )
            if ( ARMADILLO_BLAS_LONG_LONG )
                ...
                message(STATUS "MKL is linked against ILP64 interface ... ")
    ...
    SET(MKL_FOUND FALSE)
    message(WARNING "MKL is NOT found ... ")
    ...
    if ( USE_MKL_64BIT )
        ...
        if (EXISTS ${MKLROOT_PATH}/compiler})
            ...
            if (EXISTS ${MKLROOT_PATH}/composer_xe_2015.1.108/compiler)
                message(STATUS "Inside the Armadillo's belly")
