...
usage = """
{0} [input_file] [output_train_file] [output_validation_file] [(optional) validation percentage]
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 4 or len(sys.argv) > 5:
        ...
        valid_percent = float(sys.argv[4]) if len(sys.argv) == 5 else 0.1
        clean_and_output(path, outpath, valid_path, valid_percent)