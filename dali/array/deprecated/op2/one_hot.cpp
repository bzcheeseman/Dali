...
namespace rtc {
struct OneHotExpressionNode : public RtcExpression {
    ...
    OneHotExpressionNode(std::shared_ptr<const RtcExpression> indices,
                         int depth,
    ...
    std::shared_ptr<const RtcExpression> collapse_dim_with_dim_minus_one(const int& dim) const {
        return std::make_shared<OneHotExpressionNode>(
...
const hash_t OneHotExpressionNode::optype_hash = std::hash<std::string>()("OneHotExpressionNode");
}  // namespace rtc
}  // namespace expression
...
namespace op {
    expression::ExpressionGraph one_hot(
        ...
        return expression::ExpressionGraph(std::make_shared<expression::rtc::OneHotExpressionNode>(
