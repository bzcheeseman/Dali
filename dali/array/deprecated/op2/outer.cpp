...
namespace rtc {
struct OuterExpressionNode : public RtcExpression {
    static const hash_t optype_hash;
    std::shared_ptr<const RtcExpression> left_;
    std::shared_ptr<const RtcExpression> right_;

    OuterExpressionNode(std::shared_ptr<const RtcExpression> left, std::shared_ptr<const RtcExpression> right)
    ...
    std::shared_ptr<const RtcExpression> transpose(const std::vector<int>& permutation) const {
        ...
        return std::make_shared<OuterExpressionNode>(right_, left_);
    }
...
const hash_t OuterExpressionNode::optype_hash = std::hash<std::string>()("OuterExpressionNode");
}  // namespace rtc
}  // namespace expression

namespace op {
    expression::ExpressionGraph outer(const expression::ExpressionGraph& left, const expression::ExpressionGraph& right) {
        ...
        return expression::ExpressionGraph(std::make_shared<expression::rtc::OuterExpressionNode>(
