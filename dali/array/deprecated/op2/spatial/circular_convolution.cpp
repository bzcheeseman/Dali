...
namespace rtc {
struct CircularConvolutionExpressionNode : public RtcExpression {
    static const hash_t optype_hash;

    std::shared_ptr<const RtcExpression> content_;
    std::shared_ptr<const RtcExpression> weights_;

    CircularConvolutionExpressionNode(std::shared_ptr<const RtcExpression> content, std::shared_ptr<const RtcExpression> weights) :
    ...
    std::shared_ptr<const RtcExpression> collapse_dim_with_dim_minus_one(const int& dim) const {
        return std::make_shared<CircularConvolutionExpressionNode>(
...
const hash_t CircularConvolutionExpressionNode::optype_hash = std::hash<std::string>()("CircularConvolutionExpressionNode");
} // namespace rtc
} // namespace expression
...
namespace op {
    expression::ExpressionGraph circular_convolution(const expression::ExpressionGraph& x, const expression::ExpressionGraph& weights) {
        ...
        return expression::ExpressionGraph(std::make_shared<expression::rtc::CircularConvolutionExpressionNode>(
