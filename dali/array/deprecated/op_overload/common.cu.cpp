...
//     }\
//     Array& operator SYMBOL (Array& left, const expression::ExpressionGraph& assignable) {\
//         ((Assignable<Array>)assignable).assign_to(left, OPERATOR_NAME);\
//         return left;\
//     }\
//     void operator SYMBOL (Array&& left, const expression::ExpressionGraph& assignable) {\
//         Array left_instance = left;\
...
// Array& operator<<=(Array& left, const expression::ExpressionGraph& assignable) {
...
//         left = self_as_array;\
//     }\
//     CONTAINER& operator OPERATOR (CONTAINER& left, const expression::ExpressionGraph& assignable) {\
//         ((Assignable<CONTAINER>)assignable).assign_to(left, OPERATOR_NAME);\
//         return left;\
//     }\
//     void operator OPERATOR (CONTAINER&& left, const expression::ExpressionGraph& assignable) {\
//         ((Assignable<CONTAINER>)assignable).assign_to(left, OPERATOR_NAME);\
//     }\
