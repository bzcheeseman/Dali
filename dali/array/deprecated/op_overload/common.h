...
//     Array& operator SYMBOL (Array&  left, const expression::ExpressionGraph& right);\
//     void operator SYMBOL (Array&& left, const expression::ExpressionGraph& right);\
...
//     CONTAINER& operator SYMBOL (CONTAINER&  left, const expression::ExpressionGraph& right);\
//     void operator SYMBOL (CONTAINER&& left, const expression::ExpressionGraph& right);\
