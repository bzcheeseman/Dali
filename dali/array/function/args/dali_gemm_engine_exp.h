...
namespace mshadow {
    namespace expr {
        ...
        struct DaliGemmExp: public Exp<DaliGemmExp<DType, Device>,
                                  DType, type::kComplex> {
          ...
          /*! \brief constructor */
          explicit DaliGemmExp(const Tensor<Device, 2, DType> &lhs,
        ...
        struct ExpComplexEngine<SV,
                                ...
                                DaliGemmExp<DType, Device>,
                                DType> {
          inline static void Eval(Tensor<Device, 2, DType> *dst,
                                  const DaliGemmExp<DType, Device> &exp) {
