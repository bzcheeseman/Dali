...
// CublasGemmAssignExpressionNode::CublasGemmAssignExpressionNode(
...
//         CpuGemmAssignExpressionNode(dest, left, right, result_multiplier, destination_multiplier),
//         device_(device) {
// }

// void CublasGemmAssignExpressionNode::run() const {
