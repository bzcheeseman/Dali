...
CpuGemmAssignExpressionState::CpuGemmAssignExpressionState(
...
std::string CpuGemmAssignExpressionState::name() const {
    return "gemm";
}

DType CpuGemmAssignExpressionState::dtype() const {
    return left_->dtype();
}

std::vector<int> CpuGemmAssignExpressionState::bshape() const {
    return dest_->bshape();
}

int CpuGemmAssignExpressionState::ndim() const {
    return 2;
}

std::vector<std::shared_ptr<const ExpressionState>> CpuGemmAssignExpressionState::arguments() const {
    return {dest_, left_, right_};
}

void CpuGemmAssignExpressionState::run() const {
...
std::shared_ptr<const ExpressionState> CpuGemmAssignExpressionState::destination_op() const {
    return dest_;
}
