...
#define DALI_DECLARE_TENSOR_SCALAR_INTERACTION(SYMBOL)\
    ...
    Tensor& operator SYMBOL##= (Tensor& left,       const double& right);\
    Tensor& operator SYMBOL##= (Tensor& left,       const float& right );\
    Tensor& operator SYMBOL##= (Tensor& left,       const int& right   );\
