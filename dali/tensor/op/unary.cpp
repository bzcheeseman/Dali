...
namespace tensor_ops {
    ...
    DALI_DEFINE_UNARY_OP1(maximum, lower_bound, op::maximum, op::greaterthanequal(t.w, lower_bound));
    DALI_DEFINE_UNARY_OP1(minimum, upper_bound, op::minimum, op::greaterthanequal(t.w, upper_bound));
